...
describe("Post requests", () => {
    ...
    test("post story", async () => {
        ...
        const response = await supertest(app).post("/posts").send(request).set('Cookie', ['Authorization=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJ0ZXN0ZXIiLCJpYXQiOjE2MjE0MDI2NTgsImV4cCI6MTYyMTQyMDY1OH0.eJrTijMZP27mBpWWiOS5xlg91ddeof6W6Euyt2rLP4s']);
    ...
    test("edit story", async () => {
        ...
        const response = await supertest(app).put("/posts/BNR2W3lBDrK-if_B7EayLtester2021-05-18T08:47:27.406Z1621327647406").send(request).set('Cookie', ['Authorization=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJ0ZXN0ZXIiLCJpYXQiOjE2MjE0MDI2NTgsImV4cCI6MTYyMTQyMDY1OH0.eJrTijMZP27mBpWWiOS5xlg91ddeof6W6Euyt2rLP4s']);
        expect(response.statusCode).toBe(200)
    ...
    test("delete story", async () => {
        ...
        const response = await supertest(app).delete(deletePath).set('Cookie', ['Authorization=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJ0ZXN0ZXIiLCJpYXQiOjE2MjE0MDI2NTgsImV4cCI6MTYyMTQyMDY1OH0.eJrTijMZP27mBpWWiOS5xlg91ddeof6W6Euyt2rLP4s']);
        expect(response.statusCode).toBe(200)
